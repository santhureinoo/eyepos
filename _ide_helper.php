 ...
 */
     ...
     */ 
        ...
        {
                        /** @var \Illuminatech\Config\PersistentRepository $instance */
        ...
        {
                        /** @var \Illuminatech\Config\PersistentRepository $instance */
                        return $instance->resetValue($key);
        }
                    /**
         ...
         * @static 
         */ 
        public static function makeValidator($values)
        {
                        /** @var \Illuminatech\Config\PersistentRepository $instance */
                        return $instance->makeValidator($values);
        }
                    /**
        ...
        {
                        /** @var \Illuminatech\Config\PersistentRepository $instance */
                        return $instance->validate($values);
        }
                    /**
        ...
        {
                        /** @var \Illuminatech\Config\PersistentRepository $instance */
                        return $instance->setCacheKey($cacheKey);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Illuminatech\Config\PersistentRepository $instance */
                        return $instance->setCacheTtl($cacheTtl);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function setGcEnabled($gcEnabled)
        {
                        /** @var \Illuminatech\Config\PersistentRepository $instance */
                        return $instance->setGcEnabled($gcEnabled);
        }
...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Nibri10\NovaGrid\ToolServiceProvider::boot()
         * @param mixed $size
         * @static 
         */ 
        public static function size($size = 'w-full')
        {
                        return \Laravel\Nova\Fields\Field::size($size);
        }
